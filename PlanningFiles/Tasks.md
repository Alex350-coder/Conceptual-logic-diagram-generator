...
## FASE P4 — Persistencia y API (`server`)
...
## FASE P6 — Elementos conceptuales básicos
...
## FASE P7 — Relaciones y restricciones
...
## FASE P10 — Transformación Conceptual → Lógico
